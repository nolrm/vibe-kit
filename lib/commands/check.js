...
class CheckCommand {
  ...
  async checkPlatformIntegrations() {
    ...
    const deprecations = [
      {
        file: '.cursor/rules/vibe-kit.mdc',
        message: 'Deprecated monolithic Cursor rule found. Run: vk cursor (creates scoped rules)',
      },
      {
        file: '.codex/README.md',
        bridge: 'AGENTS.md',
        message: 'Legacy .codex/README.md found without AGENTS.md. Run: vk codex',
      },
      {
        file: '.gemini/README.md',
        bridge: 'GEMINI.md',
        message: 'Legacy .gemini/README.md found without GEMINI.md. Run: vk gemini',
      },
      {
        file: '.claude/README.md',
        bridge: 'CLAUDE.md',
        message: 'Legacy .claude/README.md found without CLAUDE.md. Run: vk claude',
      },
    ];
    ...
    if (!anyBridge) {
      this.warnings.push('No platform bridge files found. Run: vk <platform> (e.g., vk claude, vk cursor)');
    }
  }
