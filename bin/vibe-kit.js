...
program
  .command('check')
  .description('Validate Vibe Kit installation and check policy compliance')
...
program
  .command('publish')
  .description('Publish current Vibe Kit configuration to registry')
...
program
  ...
  .description('Pull Vibe Kit configuration from registry')
  .option('--force', 'Force overwrite existing .vibe-kit')
  .option('--backup', 'Backup existing .vibe-kit before pulling')
