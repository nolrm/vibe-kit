...
class AnalyzeCommand {
  ...
  showUsageInstructions(options) {
    ...
    console.log('');
    console.log(chalk.yellow('⚠️  After analysis completes:'));
    console.log(chalk.yellow('   1. Review updated files in .vibe-kit/standards/'));
    console.log(chalk.yellow('   2. Edit and fine-tune to match YOUR project needs'));
    console.log(chalk.yellow('   3. Keep them updated as your project evolves'));
  }
}
